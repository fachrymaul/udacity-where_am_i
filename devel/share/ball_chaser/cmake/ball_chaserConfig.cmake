...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /mnt/catkin-ws/udacity-where_am_i/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /mnt/catkin-ws/udacity-where_am_i/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /mnt/catkin-ws/udacity-where_am_i/install)
...
if(NOT "/mnt/catkin-ws/udacity-where_am_i/devel/include " STREQUAL " ")
  set(ball_chaser_INCLUDE_DIRS "")
  set(_include_dirs "/mnt/catkin-ws/udacity-where_am_i/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'fachry <fachry@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/catkin-ws/udacity-where_am_i/src/ball_chaser/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /mnt/catkin-ws/udacity-where_am_i/devel/lib;/mnt/catkin-ws/udacity-where_am_i/devel/lib;/opt/ros/kinetic/lib)
